 ...
 */
public class SocialForce implements Model {
    ...
    public SocialForce() {
        ...
        regulations.add(new ParamPsychologicalForceRegulation(Blockable.class, Agent.class, this));  //FIXME 施加心理力：行人规避障碍物的力
        regulations.add(new ParamBodyForce(Blockable.class, Agent.class, this));                     //FIXME 施加接触力
    }

    public SocialForce(double timePerStep){
        this();
