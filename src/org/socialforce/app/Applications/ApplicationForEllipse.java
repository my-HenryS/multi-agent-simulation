...
public class ApplicationForEllipse extends SimpleApplication implements Application {
    ...
    protected void setUpT1Scene5(){
        ...
        parameters.addValuesAsParameter(new SimpleEntityGenerator()
                .setValue(new DoorTurn(new Box2D(5-DoorWidth/2,-0.01,DoorWidth,1.02),new Segment2D(new Point2D(5-DoorWidth/2,-0.1),new Point2D(5+DoorWidth/2,-0.1))))  //FIXME 主动侧身作用区域（出口）的大小
                .setPriority(5)
        );
