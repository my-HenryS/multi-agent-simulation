 ...
 */
public class ApplicationEllipseForNarrowPattern extends SimpleApplication implements SocialForceApplication {
...
//        template = new Circle2D(new Point2D(0,0),0.486/2);
    ...
    protected void setUpT1Scene1(){
        ...
        parameters.addLast(genParameter(new SV_RandomAgentGenerator(1,new Box2D(3,-3,4,-4),template)));
    ...
    protected void setUpT1Scene5(){
        ...
        parameters.addLast(genParameter(new SV_RandomAgentGenerator(20,new Box2D(0,-10,10,5),template)));
