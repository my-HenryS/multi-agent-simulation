...
public class ProxyedGraphics2D extends Graphics2D {
    ...
    /**
     * Strokes the outline of a <code>ModelShape</code> using the settings of the
     * current <code>Graphics2D</code> context.  The rendering attributes
     * applied include the <code>Clip</code>, <code>Transform</code>,
     * <code>Paint</code>, <code>Composite</code> and
     * <code>Stroke</code> attributes.
     * @param s the <code>ModelShape</code> to be rendered
     * @see #setStroke
     * @see #setPaint
    ...
    /**
     * Fills the interior of a <code>ModelShape</code> using the settings of the
     * <code>Graphics2D</code> context. The rendering attributes applied
     * include the <code>Clip</code>, <code>Transform</code>,
     * <code>Paint</code>, and <code>Composite</code>.
     * @param s the <code>ModelShape</code> to be filled
     * @see #setPaint
     * @see Graphics#setColor
     * @see #transform
     * @see #setTransform
    ...
    /**
     * Checks whether or not the specified <code>ModelShape</code> intersects
     * the specified {@link Rectangle}, which is in device
     * space. If <code>onStroke</code> is false, this method checks
     * whether or not the interior of the specified <code>ModelShape</code>
     ...
     * <code>ModelShape</code> outline intersects the specified
     * <code>Rectangle</code>.
     * The rendering attributes taken into account include the
     * <code>Clip</code>, <code>Transform</code>, and <code>Stroke</code>
     * attributes.
     * @param rect the area in device space to check for a hit
     * @param s the <code>ModelShape</code> to check for a hit
     * @param onStroke flag used to choose between testing the
     * stroked or the filled modelShape.  If the flag is <code>true</code>, the
     * <code>Stroke</code> outline is tested.  If the flag is
     * <code>false</code>, the filled <code>ModelShape</code> is tested.
     ...
     * <code>ModelShape</code> during the rendering process
     * @see BasicStroke
     * @see #getStroke
     */
    @Override
     ...
     * specified <code>ModelShape</code> and sets the <code>Clip</code> to the
     * resulting intersection.  The specified <code>ModelShape</code> is
     ...
     * argument, the specified <code>ModelShape</code> becomes the new
     * user clip.
     * @param s the <code>ModelShape</code> to be intersected with the current
     ...
     * cleared using <code>setClip(null)</code>, this method returns
     * <code>null</code>.
     * @return a <code>ModelShape</code> object representing the
    ...
    /**
     * Sets the current clipping area to an arbitrary clip modelShape.
     * Not all objects that implement the <code>ModelShape</code>
     * interface can be used to set the clip.  The only
     * <code>ModelShape</code> objects that are guaranteed to be
     * supported are <code>ModelShape</code> objects that are
     * obtained via the <code>getClip</code> method and via
     * <code>Rectangle</code> objects.  This method sets the
     * user clip, which is independent of the clipping associated
     * with device bounds and window visibility.
     * @param clip the <code>ModelShape</code> to use to set the clip
     * @see         Graphics#getClip()
     * @see         Graphics#clipRect
     * @see         Graphics#setClip(int, int, int, int)
     * @since JDK1.1
